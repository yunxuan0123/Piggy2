...
namespace Newtonsoft.Json
{
	public class JsonSerializer
	{
		...
		internal GInterface3 _serializationBinder;

		internal StreamingContext _context;

		private GInterface2 _referenceResolver;
		...
		public virtual System.Runtime.Serialization.SerializationBinder Binder
		{
			get
			{
				...
				System.Runtime.Serialization.SerializationBinder serializationBinder = this._serializationBinder as System.Runtime.Serialization.SerializationBinder;
				System.Runtime.Serialization.SerializationBinder serializationBinder1 = serializationBinder;
				...
				SerializationBinderAdapter serializationBinderAdapter1 = serializationBinderAdapter;
				if (serializationBinderAdapter == null)
				{
					throw new InvalidOperationException("Cannot get SerializationBinder because an ISerializationBinder was previously set.");
				}
				return serializationBinderAdapter1.SerializationBinder;
			}
			set
			{
				if (value == null)
				...
				object serializationBinderAdapter = value as GInterface3;
				if (serializationBinderAdapter == null)
				{
					serializationBinderAdapter = new SerializationBinderAdapter(value);
				}
				this._serializationBinder = (GInterface3)serializationBinderAdapter;
			}
		}
		...
		public virtual GInterface2 ReferenceResolver
		{
			get
			{
		...
		public virtual GInterface3 SerializationBinder
		{
			get
			{
		...
		public virtual FormatterAssemblyStyle TypeNameAssemblyFormat
		{
			...
			set
			{
				...
				this._typeNameAssemblyFormatHandling = (Newtonsoft.Json.TypeNameAssemblyFormatHandling)value;
			}
		}

		public virtual Newtonsoft.Json.TypeNameAssemblyFormatHandling TypeNameAssemblyFormatHandling
		{
			get
			{
			...
			set
			{
				if (value < Newtonsoft.Json.TypeNameAssemblyFormatHandling.Simple || value > Newtonsoft.Json.TypeNameAssemblyFormatHandling.Full)
				{
					throw new ArgumentOutOfRangeException("value");
				}
		...
		internal GInterface2 GetReferenceResolver()
		{
		...
		private void ResetReader(JsonReader reader, CultureInfo previousCulture, Newtonsoft.Json.DateTimeZoneHandling? previousDateTimeZoneHandling, Newtonsoft.Json.DateParseHandling? previousDateParseHandling, Newtonsoft.Json.FloatParseHandling? previousFloatParseHandling, int? previousMaxDepth, string previousDateFormatString)
		{
			...
			JsonTextReader jsonTextReader1 = jsonTextReader;
			if (jsonTextReader != null && jsonTextReader1.PropertyNameTable != null)
			{
				DefaultContractResolver defaultContractResolver = this._contractResolver as DefaultContractResolver;
				DefaultContractResolver defaultContractResolver1 = defaultContractResolver;
				if (defaultContractResolver != null && jsonTextReader1.PropertyNameTable == defaultContractResolver1.GetNameTable())
				{
					jsonTextReader1.PropertyNameTable = null;
				}
			}
		}
		...
		internal virtual void SerializeInternal(JsonWriter jsonWriter, object value, Type objectType)
		{
			...
			if (this._formatting.HasValue)
			{
				...
				if (formatting != nullable1.GetValueOrDefault() | !nullable1.HasValue)
				{
			...
			if (this._dateFormatHandling.HasValue)
			{
				...
				if (dateFormatHandling != nullable3.GetValueOrDefault() | !nullable3.HasValue)
				{
			...
			if (this._dateTimeZoneHandling.HasValue)
			{
				...
				if (dateTimeZoneHandling != nullable5.GetValueOrDefault() | !nullable5.HasValue)
				{
			...
			if (this._floatFormatHandling.HasValue)
			{
				...
				if (floatFormatHandling != nullable7.GetValueOrDefault() | !nullable7.HasValue)
				{
			...
			if (this._stringEscapeHandling.HasValue)
			{
				...
				if (stringEscapeHandling != nullable9.GetValueOrDefault() | !nullable9.HasValue)
				{
		...
		private void SetupReader(JsonReader reader, out CultureInfo previousCulture, out Newtonsoft.Json.DateTimeZoneHandling? previousDateTimeZoneHandling, out Newtonsoft.Json.DateParseHandling? previousDateParseHandling, out Newtonsoft.Json.FloatParseHandling? previousFloatParseHandling, out int? previousMaxDepth, out string previousDateFormatString)
		{
			...
			DefaultContractResolver defaultContractResolver1;
			...
			if (this._dateTimeZoneHandling.HasValue)
			{
				...
				Newtonsoft.Json.DateTimeZoneHandling? nullable = this._dateTimeZoneHandling;
				if (dateTimeZoneHandling == nullable.GetValueOrDefault() & nullable.HasValue)
				{
					goto Label1;
				}
		...
		Label0:
			if (this._dateParseHandling.HasValue)
			{
				...
				if (dateParseHandling == nullable1.GetValueOrDefault() & nullable1.HasValue)
				{
					goto Label3;
				}
		...
		Label2:
			if (this._floatParseHandling.HasValue)
			{
				...
				if (floatParseHandling == nullable2.GetValueOrDefault() & nullable2.HasValue)
				{
					goto Label5;
				}
		...
		Label4:
			if (this._maxDepthSet)
			{
				...
				if (maxDepth.GetValueOrDefault() == nullable3.GetValueOrDefault() & maxDepth.HasValue == nullable3.HasValue)
				{
					...
					nameTable = jsonTextReader;
					if (jsonTextReader != null && nameTable.PropertyNameTable == null)
					{
						defaultContractResolver1 = this._contractResolver as DefaultContractResolver;
						defaultContractResolver = defaultContractResolver1;
						if (defaultContractResolver1 != null)
						{
							nameTable.PropertyNameTable = defaultContractResolver.GetNameTable();
						}
					}
					return;
				}
