...
namespace Newtonsoft.Json.Bson
{
	...
	public class BsonReader : JsonReader
	{
		...
		public override void Close()
		{
			...
			if (base.CloseInput)
			{
				BinaryReader binaryReader = this._reader;
		...
		{
			JsonToken jsonToken;
			BsonReader.ContainerContext containerContext;
			...
			switch (base.CurrentState)
			{
				...
				{
					jsonToken1 = (!this._readRootValueAsArray ? JsonToken.StartObject : JsonToken.StartArray);
					jsonToken = jsonToken1;
					bsonType = (!this._readRootValueAsArray ? BsonType.Object : BsonType.Array);
					base.SetToken(jsonToken);
					containerContext = new BsonReader.ContainerContext(bsonType);
					this.PushContext(containerContext);
					containerContext.Length = this.method_0();
					return true;
				}
		...
		private void ReadType(BsonType type)
		{
			...
			switch (type)
			{
				...
				case BsonType.Array:
				{
					...
					containerContext1.Length = this.method_0();
					return;
				}
				...
				case BsonType.Date:
				{
					DateTime dateTime1 = DateTimeUtils.ConvertJavaScriptTicksToDateTime(this.method_1());
				...
				{
					base.SetToken(JsonToken.Integer, (long)this.method_0());
					return;
				}
				case BsonType.TimeStamp:
				case BsonType.Long:
				{
					base.SetToken(JsonToken.Integer, this.method_1());
					return;
				}
				default:
				{
