...
namespace Newtonsoft.Json.Linq
{
	public class JTokenReader : JsonReader, IJsonLineInfo
	{
		...
		public override bool Read()
		{
			...
			if (jContainers != null && this._parent != jContainers1)
			{
				return this.ReadInto(jContainers1);
			}
			...
			switch (token.Type)
			{
				...
				case JTokenType.Date:
				{
					...
					if (obj is DateTime)
					{
						...
						value = DateTimeUtils.EnsureDateTime(dateTime, base.DateTimeZoneHandling);
					}
					base.SetToken(JsonToken.Date, value);
					return;
				}
				case JTokenType.Raw:
				{
				...
				case JTokenType.Uri:
				{
					object value1 = ((JValue)token).Value;
					Uri uri = value1 as Uri;
					Uri uri1 = uri;
					base.SetToken(JsonToken.String, (uri != null ? uri1.OriginalString : this.SafeToString(value1)));
					return;
				}
