...
namespace Newtonsoft.Json
{
	public class JsonSerializerSettings
	{
		...
		internal const Newtonsoft.Json.TypeNameAssemblyFormatHandling DefaultTypeNameAssemblyFormatHandling = Newtonsoft.Json.TypeNameAssemblyFormatHandling.Simple;
		...
		public System.Runtime.Serialization.SerializationBinder Binder
		{
			get
			{
				...
				SerializationBinderAdapter serializationBinderAdapter = serializationBinder;
			...
			set
			{
				GInterface3 serializationBinderAdapter;
				if (value == null)
				{
					serializationBinderAdapter = null;
				}
				else
				{
					serializationBinderAdapter = new SerializationBinderAdapter(value);
				}
				this.SerializationBinder = serializationBinderAdapter;
			}
		}
		...
		public GInterface2 ReferenceResolver
		{
			get
			{
				Func<GInterface2> referenceResolverProvider = this.ReferenceResolverProvider;
		...
		public Func<GInterface2> ReferenceResolverProvider
		{
			get;
			set;
		}

		public GInterface3 SerializationBinder
		{
			get;
			set;
		}
		...
		public FormatterAssemblyStyle TypeNameAssemblyFormat
		{
			...
			set
			{
				this.TypeNameAssemblyFormatHandling = (Newtonsoft.Json.TypeNameAssemblyFormatHandling)value;
			}
		}

		public Newtonsoft.Json.TypeNameAssemblyFormatHandling TypeNameAssemblyFormatHandling
		{
			get
			{
				Newtonsoft.Json.TypeNameAssemblyFormatHandling? nullable = this._typeNameAssemblyFormatHandling;
				if (!nullable.HasValue)
				{
					return Newtonsoft.Json.TypeNameAssemblyFormatHandling.Simple;
				}
				return nullable.GetValueOrDefault();
			}
			set
			{
				this._typeNameAssemblyFormatHandling = new Newtonsoft.Json.TypeNameAssemblyFormatHandling?(value);
			}
		}
