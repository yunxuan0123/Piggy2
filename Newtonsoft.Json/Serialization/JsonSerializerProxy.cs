...
namespace Newtonsoft.Json.Serialization
{
	internal class JsonSerializerProxy : JsonSerializer
	{
		...
		public override GInterface2 ReferenceResolver
		{
			get
			{
		...
		public override GInterface3 SerializationBinder
		{
			get
			{
		...
		public override Newtonsoft.Json.TypeNameAssemblyFormatHandling TypeNameAssemblyFormatHandling
		{
			get
			{
